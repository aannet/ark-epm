...
> **Changelog v0.3 :** Unification des versions v0.1 et v0.2. Réorganisation en 5 sprints + Phase 0 (9 tâches). Terminologie统一ifiée sur "OpenCode". Ajout des gates de validation entre phases.
...
_Document v0.3 — Réconcilié et unifié_
